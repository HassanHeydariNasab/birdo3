...
onready var FPS = $Canvas/Container/FPS
onready var Bird = get_node("Bird")
onready var Camera = get_node("Camera")
onready var Energy_label = $Canvas/Container/Energy
onready var Life_label = $Canvas/Container/Life
onready var Cubes_label = $Canvas/Container/Cubes
